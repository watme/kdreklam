...
sdcript.innerHTML='<style>#eleaefm{position: absolute;z-index:9999999;width: 240px;height: 400px;border:1px solid #a1b1ec;-webkit-user-select: none;-moz-user-select: none;-o-user-select: none;-ms-user-select: none;-khtml-user-select: none;user-select: none;cursor: default;padding:30px 6px 6px 6px;-webkit-border-radius: 4px;border-radius: 4px;-moz-box-shadow: 0 0 5px #888;-webkit-box-shadow: 0 0 5px #888;box-shadow: 0 0 5px #888;background: #b1c1d5;background: -moz-linear-gradient(-45deg,  #b1c1d5 0%, #f2f6ff 100%);background: -webkit-gradient(linear, left top, right bottom, color-stop(0%,#b1c1d5), color-stop(100%,#f2f6ff));background: -webkit-linear-gradient(-45deg,  #b1c1d5 0%,#f2f6ff 100%);background: -o-linear-gradient(-45deg,  #b1c1d5 0%,#f2f6ff 100%);background: -ms-linear-gradient(-45deg,  #b1c1d5 0%,#f2f6ff 100%);background: linear-gradient(135deg,  #b1c1d5 0%,#f2f6ff 100%);filter: progid:DXImageTransform.Microsoft.gradient( startColorstr="#b1c1d5", endColorstr="#f2f6ff",GradientType=1 );}#eleaefm span{color:#fff !important;font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;position:absolute;top:3px;right:8px;text-shadow: #55d 0px 0px 3px}</style>';
